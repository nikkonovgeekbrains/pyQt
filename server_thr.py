            ...
            try:
                ...
                if "action" in msg_data and msg_data[
                    ...
                    if msg_data["user"]["account_name"] not in self.cl_names.keys():
                        ...
                        cl_addr, cl_port = client.getpeername()
                        self.server_db.reg_user_login(msg_data["user"]["account_name"], cl_addr, cl_port)
                    else:
                ...
                # Exit
                    ...
                    self.server_db.reg_user_logout(msg_data["account_name"])
                ...
                for us_name in self.cl_names:
                    if self.cl_names[us_name] == client:
                        ...
                        self.server_db.reg_user_logout(us_name)
                if find_fl:
